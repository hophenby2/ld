...
constexpr std::array<SoundResourceSpec, 67> kSounds{{
    ...
    {"SE_se_Timer", "media\\se\\Timer.wav", SoundKind::Se, 3},
    {"SE_se_BossSE1", "media\\se\\BossSE1.wav", SoundKind::Se, 3},
    {"SE_se_BossSE2", "media\\se\\BossSE2.wav", SoundKind::Se, 3},
    {"SE_se_BossSE2_2", "media\\se\\BossSE2.wav", SoundKind::Se, 3},
    {"SE_se_BossSE3", "media\\se\\BossSE3.wav", SoundKind::Se, 3},
    {"SE_se_BossSE4", "media\\se\\BossSE4.wav", SoundKind::Se, 3},
