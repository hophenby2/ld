// Function: state_03_stage_start_init_candidate @ 1400d4610
// Decompile completed: true

/* WARNING: Function: __security_check_cookie replaced with injection: security_check_cookie */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void state_03_stage_start_init_candidate(void)

{
  ...
  if ((int)uVar14 < 0x3c) {
    transition_tile_wipe_in_candidate(uVar14);
    uVar14 = DAT_140e418c8;
  }
...
LAB_1400d5adf:
  ...
  if (0x1e < (int)DAT_140e45fac) {
    transition_tile_wipe_out_candidate(DAT_140e45fac - 0x1e);
  }
