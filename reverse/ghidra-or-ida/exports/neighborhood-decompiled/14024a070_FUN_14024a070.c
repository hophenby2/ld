// Function: FUN_14024a070 @ 14024a070
// Decompile completed: true

/* WARNING: Function: __security_check_cookie replaced with injection: security_check_cookie */

undefined8 FUN_14024a070(undefined8 param_1,int param_2,int param_3,int param_4)

{
  ...
  if (iVar1 == 0) {
    ...
    FUN_140156d20(0);
    piVar5 = (int *)(&DAT_140b18a1c + lVar4 * 4);
    if (*(int *)(&DAT_140b18a1c + lVar4 * 4) < 0) {
      iVar1 = FUN_140248fc0((&PTR_s_BrightnessScale_pso_14066f560)[lVar4],1);
      *piVar5 = iVar1;
      if (iVar1 < 0) {
        local_110 = 0x4b0;
        local_118 = (float *)0x80;
        FUN_1401c0470((&PTR_s_BrightnessScale_pso_14066f560)[lVar4],0xffffffff,0x7ffd,local_b8);
    ...
    local_110 = 1;
    local_c0 = 0;
    local_c8 = (float)param_2 / DAT_14053adec;
    local_c4 = DAT_14053adec / (float)(param_3 - param_2);
