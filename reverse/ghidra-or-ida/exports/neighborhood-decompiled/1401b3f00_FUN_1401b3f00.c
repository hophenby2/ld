// Function: FUN_1401b3f00 @ 1401b3f00
// Decompile completed: true

int FUN_1401b3f00(longlong *param_1)

{
  ...
  if (((int)param_1[8] == 1) && (*(int *)((longlong)param_1 + 0x44) != 0)) {
    do {
      if (((int)param_1[8] == 0) || (iVar5 = *(int *)((longlong)param_1 + 0x44), iVar5 == 0)) break;
      if (iVar5 == 1) {
        ...
        if (iVar5 != 0) {
          ...
          if (uVar3 == 0xffffffffffffffff) {
            if (lVar4 != -1) {
              ...
              if ((char)param_1[5] == '\0') {
                FUN_1401b3000(param_1[3],lVar4,*(undefined8 *)(lVar2 + 0x30),
                              (longlong)param_1 + 0x29);
              }
              FUN_1401b5b00(param_1[3],param_1[2]);
            }
