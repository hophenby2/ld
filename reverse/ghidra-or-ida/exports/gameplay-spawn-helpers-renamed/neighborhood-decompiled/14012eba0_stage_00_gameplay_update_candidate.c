// Function: stage_00_gameplay_update_candidate @ 14012eba0
// Decompile completed: true

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void stage_00_gameplay_update_candidate(void)

{
  ...
  case 0:
    ...
    break;
  case 1:
    stage_intro_skip_prompt_candidate(2);
    break;
  case 2:
    cVar8 = '3';
    stage_intro_skip_prompt_candidate(3);
    break;
  case 3:
    cVar8 = '4';
    stage_intro_skip_prompt_candidate(4);
    break;
  case 4:
    cVar8 = '5';
    stage_intro_skip_prompt_candidate(5);
    break;
  case 5:
    cVar8 = '6';
    ...
    stage_hud_or_option_panel_candidate(0);
...
LAB_14012f02b:
  ...
  case 6:
    cVar8 = '7';
    stage_intro_skip_prompt_candidate(7);
    break;
  case 7:
    cVar8 = '8';
    stage_intro_skip_prompt_candidate(8);
    break;
  case 8:
    cVar8 = (DAT_140e44194 != 1) + '9';
    stage_intro_skip_prompt_candidate(9);
    break;
  case 9:
    cVar8 = ';';
    stage_hud_or_option_panel_candidate(1);
    if (DAT_140e418c8 == 100) {
      stage_spawn_dispatch_candidate(0,0x5dc,0xf0,0);
      stage_spawn_dispatch_candidate(0,0x5dc,0x1e0,0);
    }
    if (DAT_140e9fd0c == 2) {
      stage_spawn_dispatch_candidate(0,0x5dc,0xdc,0);
      stage_spawn_dispatch_candidate(0,0x5dc,0x168,0);
      stage_spawn_dispatch_candidate(0,0x5dc,500,0);
      DAT_140e9fd0c = DAT_140e9fd0c + 1;
    }
    if (DAT_140e9fd0c == 6) {
      stage_spawn_dispatch_candidate(0,0x5dc,0x78,0);
      stage_spawn_dispatch_candidate(0,0x5dc,0x118,0);
      stage_spawn_dispatch_candidate(0,0x5dc,0x1b8,0);
      stage_spawn_dispatch_candidate(0,0x5dc,600,0);
      DAT_140e9fd0c = DAT_140e9fd0c + 1;
    }
    uVar16 = uVar17;
  ...
  case 10:
    cVar8 = '<';
    stage_intro_skip_prompt_candidate(0xb);
    break;
  case 0xb:
    cVar8 = '=';
    stage_intro_skip_prompt_candidate(0xc);
    break;
  case 0xc:
    cVar8 = (DAT_140e44194 != 1) + '>';
    stage_intro_skip_prompt_candidate(0xd);
    break;
  case 0xd:
    cVar8 = '@';
    stage_intro_skip_prompt_candidate(0xe);
    break;
  case 0xe:
    cVar8 = 'A';
    stage_hud_or_option_panel_candidate(2);
    if (DAT_140e418c8 == 100) {
      stage_spawn_dispatch_candidate(2,8000,0x168,0);
    }
    if (DAT_140e9fd0c == 1) {
      stage_spawn_dispatch_candidate(2,8000,0xb4,0);
      DAT_140e9fd0c = DAT_140e9fd0c + 1;
    }
    if (DAT_140e9fd0c == 3) {
      stage_spawn_dispatch_candidate(2,8000,0x21c,0);
      DAT_140e9fd0c = DAT_140e9fd0c + 1;
    }
    if (DAT_140e9fd0c == 5) {
      stage_spawn_dispatch_candidate(2,8000,0xdc,0);
      stage_spawn_dispatch_candidate(2,8000,500,0);
      DAT_140e9fd0c = DAT_140e9fd0c + 1;
    }
    uVar16 = uVar17;
...
LAB_14012f420:
  ...
  case 0xf:
    cVar8 = 'B';
    stage_intro_skip_prompt_candidate(0x10);
    break;
  case 0x10:
    cVar8 = 'C';
    stage_intro_skip_prompt_candidate(0x11);
    break;
  case 0x11:
    cVar8 = 'D';
    stage_intro_skip_prompt_candidate(0x12);
    break;
  case 0x12:
    cVar8 = 'E';
    stage_intro_skip_prompt_candidate(0x13);
    break;
  case 0x13:
    cVar8 = 'F';
    stage_hud_or_option_panel_candidate(4);
    if (DAT_140e418c8 == 0xa0) {
      stage_spawn_dispatch_candidate(1,3000,0x168,0);
    }
    if (DAT_140e9fd0c == 1) {
      stage_spawn_dispatch_candidate(1,3000,0xb4,0);
      stage_spawn_dispatch_candidate(1,3000,0x21c,0);
      DAT_140e9fd0c = DAT_140e9fd0c + 1;
    }
    if (DAT_140e9fd0c == 4) {
      stage_spawn_dispatch_candidate(1,3000,0xa0,0);
      stage_spawn_dispatch_candidate(1,3000,0x168,0);
      stage_spawn_dispatch_candidate(1,3000,0x230,0);
      DAT_140e9fd0c = DAT_140e9fd0c + 1;
    }
    if (DAT_140e9fd0c == 8) {
      stage_spawn_dispatch_candidate(3,40000,0x168,0);
      DAT_140e9fd0c = DAT_140e9fd0c + 1;
    }
...
LAB_14012f77f:
  ...
  case 0x15:
    cVar8 = 'H';
    stage_intro_skip_prompt_candidate(0x16);
    break;
  case 0x16:
    cVar8 = 'I';
    stage_intro_skip_prompt_candidate(0x17);
    break;
  case 0x17:
    stage_continue_prompt_candidate(0x18,0);
    break;
  case 0x18:
    dVar14 = dVar3;
    ...
    *(undefined8 *)(puVar6 + 0x10) = 0;
    ...
    stage_intro_skip_prompt_candidate(0x19);
    break;
  case 0x19:
    cVar8 = 'K';
    stage_intro_skip_prompt_candidate(0x1a);
    break;
  case 0x1a:
    cVar8 = 'L';
    stage_intro_skip_prompt_candidate(0x1b);
    break;
  case 0x1b:
    cVar8 = 'M';
    stage_hud_or_option_panel_candidate(4);
    if (DAT_140e418c8 == 100) {
      ...
      stage_spawn_dispatch_candidate(4,10000,0x1c5,0);
    }
    if (0 < (int)DAT_140e9fd0c) {
      ...
      if (uVar9 == 1) {
        ...
        DAT_140e9fd18 = (DAT_140e9fd14 >> 0x1e ^ DAT_140e9fd14) * 0x6c078965 + 4;
        DAT_140e9fd1c = (DAT_140e9fd18 >> 0xb ^ uVar9) >> 8 ^ uVar9 ^ DAT_140e9fd18;
        stage_spawn_dispatch_candidate(4,10000,DAT_140e9fd1c % 0x169 + 0x78,0);
        DAT_140e9fd0c = DAT_140e9fd0c + 1;
      }
    }
    uVar16 = uVar17;
...
LAB_14012fb21:
  ...
  case 0x1c:
    cVar8 = 'N';
    stage_intro_skip_prompt_candidate(0x1d);
    break;
  case 0x1d:
    cVar8 = 'O';
    stage_hud_or_option_panel_candidate(5);
    if (DAT_140e418c8 == 0x82) {
      stage_spawn_dispatch_candidate(5,99999999,0x168,0);
    }
    uVar16 = uVar17;
  ...
  case 0x1e:
    cVar8 = 'P';
    stage_intro_skip_prompt_candidate(0x1f);
    break;
  case 0x1f:
    cVar8 = 'Q';
    stage_intro_skip_prompt_candidate(0x20);
    break;
  case 0x20:
    cVar8 = 'R';
    stage_intro_skip_prompt_candidate(0x21);
    break;
  case 0x21:
    cVar8 = 'S';
    stage_hud_or_option_panel_candidate(3);
    if (DAT_140e418c8 == 100) {
      DAT_140e9fd10 = 0x7a4d422b;
      DAT_140e9fd14 = 0x20099495;
      DAT_140e9fd18 = 0xb05e5bcd;
  ...
  case 0x23:
    cVar8 = 'U';
    stage_intro_skip_prompt_candidate(0x24);
    break;
  case 0x24:
    cVar8 = 'V';
    stage_intro_skip_prompt_candidate(0x25);
    break;
  case 0x25:
    stage_continue_prompt_candidate(0x26,1);
    break;
  case 0x26:
    dVar14 = dVar3;
    if (0x4f < (int)DAT_140e418c8) {
    ...
    *(undefined8 *)(puVar6 + 0x10) = 0;
    ...
    cVar8 = 'W';
    DAT_140e46c88 = puVar6;
    stage_intro_skip_prompt_candidate(0x27);
    break;
  case 0x27:
    cVar8 = 'X';
    stage_intro_skip_prompt_candidate(0x28);
    break;
  case 0x28:
    cVar8 = 'Y';
    stage_intro_skip_prompt_candidate(0x29);
    break;
  case 0x29:
    cVar8 = 'Z';
    stage_intro_skip_prompt_candidate(0x2a);
    break;
  case 0x2a:
    cVar8 = '[';
    stage_intro_skip_prompt_candidate(0x2b);
    break;
  case 0x2b:
    cVar8 = '\\';
    stage_intro_skip_prompt_candidate(0x2c);
    break;
  case 0x2c:
    cVar8 = ']';
    stage_intro_skip_prompt_candidate(0x2d);
    break;
  case 0x2d:
    stage_continue_prompt_candidate(0x2e,2);
    break;
  case 0x2e:
    dVar14 = dVar3;
    if (0x4f < (int)DAT_140e418c8) {
    ...
    *(undefined8 *)(puVar6 + 0x10) = 0;
    ...
    cVar8 = '^';
    DAT_140e46c88 = puVar6;
    stage_intro_skip_prompt_candidate(0x2f);
    break;
  case 0x2f:
