...

{
  ...
  if (DAT_1407c7798 == 9) {
    stage_intro_banner_event_candidate(0xb7,0xc,uVar9,0,0xa0,1);
    iVar10 = 0xb8;
    ...
    stage_intro_banner_event_candidate
              (DAT_1407c7798 * 10 + 0x5d + DAT_140e445c0,DAT_1407c7798 + 3,uVar9,0,0xa0,1);
    if (DAT_1407c7798 == 7) {
      stage_intro_banner_event_candidate(DAT_140e445c0 + 200,0xf,uVar9,0,0xa0,2);
    }
    uVar20 = 0;
    iVar10 = DAT_140e445c0 + (DAT_1407c7798 * 5 + 0x30) * 2;
    iVar8 = DAT_140e445c0;
  }
  stage_intro_banner_event_candidate(iVar10,iVar8,uVar9,0x8c,300,uVar20);
